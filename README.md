    ...
    <div class="container-fluid" style="background-color: rgb(90, 199, 241);"  >
        ...
        <nav class="navbar navbar-expand-sm bg-light navbar-light">
          ...
          <nav class="navbar navbar-expand-sm bg-primary navbar-dark">
            ...
            <li><center>
                <ul>
                  <img src="https://bprd.nic.in/WriteReadData/Gallery/PhotoGallery/Thumbnail/NPM%20third%20NC.JPG">
                </ul>
            </center></li>
                    ...
                    <div class="row">
                      <div class="col-sm-4">
                        ...
                        <ul class="nav nav-pills flex-column">
                          ...
                          <li class="nav-item">
                            <a class="nav-link bg-light" href="#">Data On Police Organization</a>
                          </li>
                        </ul>
                        <hr class="d-sm-none">
                      </div>
                      <div class="col-sm-8">
                        ...
                        <div class="img">
                            <a href="#" class="link-dark">Bureau Darpan</a><br>
                            <a href="#" class="link-dark">Invitation of application for the paid Internship Programme at BPR&D for the year 2022-23</a><br>
                            <a href="#" class="link-dark">Proceedings of the Webinar on Woman Safety with Sensitivity</a><br>
                            <a href="#" class="link-dark">Pandit Govind vallab pant Puraskar Yojana</a><br>
                            <a href="#" class="link-dark">Directory of Prison Officials in India 2021</a><br>
                            <a href="#" class="link-dark">WOMEN SAFETY & SECURITY- A Handbook for First Responders and Investigators in the Police</a><br>
                            <a href="#" class="link-dark">Data on Police Organization</a><br>
                            <a href="#" class="link-dark">Investigative Workflow Manual on Cyber Harassment Cases</a><br>
                        </div>
            ...
            <a href="#" class="link-light">Sitemap</a> ┃
            <a href="#" class="link-light">Accessibility Options</a> ┃
            <a href="#" class="link-light">Privacy Policy</a> ┃
            <a href="#" class="link-light">Hyperlinking Policy</a> ┃
            <a href="#" class="link-light">Copyright Policy</a> ┃
            <a href="#" class="link-light">Terms and Condition</a> ┃
            <a href="#" class="link-light">Feedback</a> ┃
            <a href="#" class="link-light">Other Links</a> ┃
            <a href="#" class="link-light">Archives</a> ┃
            <a href="#" class="link-light">RTI</a> ┃
            <a href="#" class="link-light">Tender</a> ┃
            <a href="#" class="link-light">Help</a> ┃
            <a href="#" class="link-light">Digital India</a> ┃
            <a href="#" class="link-light">my GOV</a> ┃
    ...
    <div class="container-fluid" style="background-color: rgb(90, 199, 241);"  >
        ...
        <nav class="navbar navbar-expand-sm bg-light navbar-light">
          ...
          <nav class="navbar navbar-expand-sm bg-primary navbar-dark">
              ...
              <a class="navbar-brand" href="./sample.html">Home</a>
              <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#collapsibleNavbar">
                <span class="navbar-toggler-icon"></span>
              </button>
              <div class="collapse navbar-collapse" id="collapsibleNavbar">
            ...
            <div class="container-fluid mt-2 mb-2 ms-2 me-2" style="background-color:#41ffff; ">
                <div class="row">
                       ...
                       <br> <h2 style="font-size:larger">
                        ...
                        <h2 style="font-size:larger">
                         ...
                         <li style="font-size: larger; ">
                            <ul>
                              <li><a >(i)   Traffic and Transport Wing.</a></li>
                              <li><a >(ii)   Uniform Accouterments Wing.</a></li>
                              <li><a >(iii)  Weapon Wing.</a></li>
                              <li><a >(iv)  Electronics Wing.</a></li>
                              <li><a >(v)  Building and Design Wing.</a></li>
                              <li><a >(vi)  Life Sciences Wing.</a></li>
                              <li><a >(vii) Ballistics & Explosive Wing.</a></li>
                            </ul>
                          </li>
                    </div>
                    <div class="col-sm-3 mt-2">
